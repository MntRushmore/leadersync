  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>ConvoConnect - Career Advice & Mentorship for Students | Find a Mentor</title>
        <meta name="description" content="Get free career advice and professional mentorship from CEOs and industry leaders. ConvoConnect connects college students with mentors for one-on-one video tutoring, career guidance, and professional development." />
